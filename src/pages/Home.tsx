...
const Home = () => {
  return (
    <>
        <HeroSection bgCSS={{ backgroundImage : 'url("images/mainbanner.png")'}}>
          ...
          <h3 className=" text-base md:text-lg text-white">to today’s challenges across the nation and around the world and to preparing for <span className="text-nsgreen">tomorrow’s environmental trends.</span></h3>
        </HeroSection>
