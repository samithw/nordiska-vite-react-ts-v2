...
const Services = (props: Props) => {
  return (
    <>
        ...
        <ContentSection sectionTitle='business support' buttonTitle='Inquire' bgImageCSS='linear-gradient(45deg, #1D3B42 10%, #1D3B42 90%)' sectionImageURL='./src/assets/images/icon__business__support.png'>
            <>
